...
class Protocol(BaseModel):
    ...
    def to_python_code(self) -> str:
        ...
        Returns:
            ...
            to opentron_OT2.upload_and_run() or upload_protocol().
        """
...
def upload_protocol(client: Any, code: str, filename: str = "protocol.py") -> str:
    ...
    This function is called internally by opentron_OT2.upload_and_run().
    Use that method for the full upload-and-run workflow.

    Args:
        client: Connected opentron_OT2 instance.
